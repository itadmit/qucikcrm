...
import { Zap, ArrowLeft, UserPlus, CheckSquare, Calendar, User, Mail, FileText, Bell, Tag, Edit3, FolderPlus, Plus, X, ListChecks } from "lucide-react"
  ...
  useEffect(() => {
    if (open && automation) {
      ...
      setFormData({
        ...
        taskChecklist: firstAction?.params?.checklist || [],
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {[
                  ...
                  { value: 'project_created', label: 'פרויקט חדש נוצר', icon: FolderPlus, desc: 'כאשר נוצר פרויקט חדש' },
                ].map((trigger) => {
                ...
                <div className="mt-4 p-4 bg-zinc-50 rounded-lg space-y-3">
                  <div>
                    ...
                    <Input
                      ...
                      placeholder="למשל: נוהל פתיחת אתר חדש"
                    />
                  </div>
                  <div>
