...
export default function QuotesPage() {
  ...
  const [resendQuote, setResendQuote] = useState<{ id: string; quoteNumber: string; email: string | null } | null>(null)
      ...
      <div className="flex justify-between items-center mb-8">
                                ...
                                <DropdownMenuItem 
                                  onClick={(e) => {
                                    ...
                                    setResendQuote({
                                      ...
                                      email: quote.lead?.email || quote.client?.email || null,
                                    })
        ...
        <NewQuoteDialog
          ...
          onOpenChange={(open) => {
            ...
            if (!open) setDuplicateQuote(null)
          }}
          onSuccess={fetchQuotes}
          duplicateFrom={duplicateQuote}
        />
      ...
      {selectedQuote && (
        ...
        {resendQuote && (
          <ResendEmailDialog
            ...
            onOpenChange={setResendEmailOpen}
            quoteId={resendQuote.id}
            quoteNumber={resendQuote.quoteNumber}
            defaultEmail={resendQuote.email}
            onSuccess={fetchQuotes}
          />
        )}
      </AppLayout>
